...
import { Crown, Users, MapPin, Briefcase, X, Save, Trash2, Eye } from 'lucide-react';
          ...
          <Card className="bg-white rounded-2xl border border-gray-100 text-center">
            <CardContent className="p-8">
              ...
              <p className="text-gray-500 text-sm mb-4">
                Please select candidates and form a team to get started.
              </p>
              ...
              <Card key={team.id} className="bg-white rounded-2xl border border-gray-100 hover:shadow-lg transition-shadow">
                <CardHeader className="p-4">
                  ...
                  <Button
                    ...
                    className="w-full bg-[#4c4cc9] hover:bg-[#4c4cc9]/90 text-white text-sm rounded-xl py-2 flex items-center justify-center space-x-2"
                  >
      ...
      <CardHeader className="p-6 border-b border-gray-100">
        ...
        <div className="mt-4">
          ...
          <input
            ...
            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#4c4cc9] text-sm"
          />
        </div>
      </CardHeader>
              ...
              <Card key={candidate.id} className="bg-gray-50 rounded-2xl border border-gray-100 relative">
                ...
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-gray-900">{candidate.name || 'name not available'}</h4>
